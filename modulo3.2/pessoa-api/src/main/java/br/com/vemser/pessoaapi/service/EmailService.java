...
public class EmailService {
    ...
    public void sendEmailPessoaDeletada(PessoaEntity pessoa) {
        MimeMessage mimeMessage = emailSender.createMimeMessage();
        try {
    ...
    public void sendEmailEnderecoCriado(EnderecoCreateDTO enderecoDTO, PessoaEntity  pessoa) {
    ...
    public void sendEmailEnderecoAlterado(EnderecoCreateDTO enderecoDTO, PessoaEntity  pessoa) {
    ...
    public void sendEmailEnderecoDeletado(EnderecoEntity enderecoEntity, PessoaEntity  pessoa) {
        ...
        try {
            ...
            mimeMessageHelper.setText(buscarConteudoEnderecoDeletado(enderecoEntity, pessoa), true);
    ...
    public String buscarConteudoEnderecoDeletado(EnderecoEntity enderecoEntity, PessoaEntity  pessoa) throws IOException, TemplateException {
        Map<String, Object> dados = new HashMap<>();
        dados.put("nome", "Olá, " + pessoa.getNome());
        dados.put("mensagem", "Seu endereço " + enderecoEntity.getTipo() + " foi excluído com sucesso!");
        dados.put("email", "Qualquer dúvida, nos contate através do e-mail " + from);
